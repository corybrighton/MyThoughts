...
function taskbook_add_capabilities(){
    ...
    foreach ($manager_roles as $the_role){
        ...
        $role->add_cap('delete_private_task');
        $role->add_cap('delete_others_task');
...
function taskbook_remove_capabilities(){
    ...
    foreach ($manager_roles as $the_role){
        ...
        $role->remove_cap('delete_private_task');
        $role->remove_cap('delete_others_task');
